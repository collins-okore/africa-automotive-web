  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        Header: "First Name",
        accessor: (row) =>
          `${row?.attributes?.user?.data?.attributes?.firstName || ""} ${
            row?.attributes?.user?.data?.attributes?.otherNames || ""
          }`,
        id: "firstName",
        filterable: false,
        Cell: (cell) => {
      ...
      },
      {
        ...
        accessor: (row) =>
          row?.attributes?.user &&
          `${row?.attributes?.user?.data?.attributes?.phoneCode || ""}${
            row?.attributes?.user?.data?.attributes?.phoneNumber || ""
          }`,
        id: "phoneNumber",
        filterable: false,
      },
      {
        ...
        accessor: "attributes.user.data.attributes.postalAddress",
        id: "postalAddress",
        filterable: false,
      },

      {
        ...
        accessor: "attributes.user.data.attributes.idOrPassportNumber",
        id: "code",
        filterable: false,
      },
