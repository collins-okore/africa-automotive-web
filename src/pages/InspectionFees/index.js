...
//Import actions
import {
  getInspectionFees as onGetInspectionFees,
  deleteInspectionFee as onDeleteInspectionFee,
} from "../../slices/thunks";
...
import AddInspectionFee from "./AddInspectionFee";
import UpdateInspectionFee from "./UpdateInspectionFee";
              ...
              <Col sm={5}>
                <div className={"search-box me-2 mb-2 d-inline-block col-12"}>
                  <input
                    ...
                    placeholder={"Search inspection fee"}
                    value={searchValue || ""}
                  />
...
const InspectionFee = () => {
  ...
  const fetchUpdatedinspectionFees = useCallback(() => {
    onPageChange(pageCache);
  }, [pageCache, onPageChange]);

  // Delete Data
  const onClickDelete = (inspectionFee) => {
    setSelectedRecord(inspectionFee);
    setDeleteModal(true);
  };
  ...
  const handleDelete = () => {
    if (selectedRecord) {
      setDeleting(true);
      dispatch(onDeleteInspectionFee(selectedRecord)).then(() => {
        setDeleting(false);
  ...
  const showUpdateModalForm = (inspectionFee) => {
    setSelectedRecord(inspectionFee);
  ...
  document.title = "Inspection Fee List | Automotive Africa";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        ...
        <Container fluid>
          <BreadCrumb title="Inspection Fee List" pageTitle="Inspection Fees" />
              ...
              <Card id="invoiceList">
                ...
                <CardBody className="pt-0">
                  ...
                  <AddInspectionFee
                    ...
                    fetchInspectionFee={fetchInspectionFee}
                  />
                  <UpdateInspectionFee
                    toggle={() => setIsUpdateModalOpen((state) => !state)}
                    isModalOpen={isUpdateModalOpen}
                    selectedRecord={selectedRecord}
                    fetchUpdatedinspectionFees={fetchUpdatedinspectionFees}
                  />
                </CardBody>
              </Card>
            </Col>
