...
export const POST_JWT_LOGIN = "/auth/signin";
...
export const ADD_NEW_PAYMENT = "/payments";
export const UPDATE_PAYMENT = "/payments";
...
// Payment Type
export const GET_FUEL_TYPES = "/vehicle-fuel-types";
...
export const ADD_TASKS = "/apps/task";
export const UPDATE_TASKS = "/apps/task";
export const DELETE_TASKS = "/apps/task";
